<section class="border-t-2 border-primary">
	<div class="mx-auto max-w-6xl px-5 xl:px-0 py-10">
		<div class="flex flex-col md:flex-row space-y-5 md:space-y-0 space-x-0 md:space-x-36 items-start">
			<div class="w-full">
			...
			<div class="w-full">
				<h4 class="text-2xl font-semibold mb-3">Kontak</h4>
			...
			<div class="w-full">
				<h4 class="text-2xl font-semibold mb-3">Alamat</h4>
