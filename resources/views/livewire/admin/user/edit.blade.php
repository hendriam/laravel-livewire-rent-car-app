<div class="space-y-4">
    <h2 class="text-xl font-bold">Manamejen User</h2>
    ...
    <x-ui.admin.card>
        ...
        <x-ui.admin.card-header>
            <h2 class=" text-lg font-semibold text-gray-900 dark:text-white">Edit user {{ $user->fullname }}</h2>
        ...
        <form wire:submit.prevent="update" class="max-w-2xl pb-3">
            <div class="grid gap-3 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <x-ui.select wire:model.defer="role">
                        <option selected="">Select role</option>
                        <option value="superadmin">Super admin</option>
                        <option value="operasional">Operasional</option>
                        <option value="kasir">Kasir</option>
                    </x-ui.select>
                    @error('role')<p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oops!</span> {{ $message }}!</p>@enderror
                </div>
