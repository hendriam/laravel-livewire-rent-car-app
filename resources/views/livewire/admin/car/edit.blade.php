<div class="space-y-4">
    ...
    <x-ui.admin.card>
        ...
        <x-ui.admin.card-header>
            <h2 class=" text-lg font-semibold text-gray-900 dark:text-white">Edit mobil {{ $car->model }}</h2>
        ...
        <form wire:submit.prevent="update" class="w-full pb-3">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-3 items-start lg:gap-5">
                <div class="grid gap-3 sm:grid-cols-2">
                    ...
                    <div class="w-full">
                        <x-ui.label for="price_without_driver">Harga Tanp Supir / Hari</x-ui.label>
                ...
                <div class="">
                    ...
                    <div wire:loading.remove wire:target="photo">
                        ...
                        @elseif ($oldPhotoPath)
                            <img src="{{ asset('storage/' . $oldPhotoPath) }}" class="mt-2 w-md h-auto rounded" />
                        @endif
                    </div>
                </div>
            </div>
